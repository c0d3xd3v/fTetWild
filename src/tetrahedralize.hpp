...
namespace wildmeshing_binding
{
    ...
    public:
        ...
        Tetrahedralizer(
            double stop_quality = 10.0, int max_its = 80, int stage = 2, int stop_p = -1,
            double epsilon = 1.e-3, double edge_length_r = 1./20.,
            bool skip_simplify = false, bool coarsen = true);
    ...
    public:
        ...
        void get_surface_triangles(Eigen::Matrix<int, Eigen::Dynamic, 3> &Ft);
